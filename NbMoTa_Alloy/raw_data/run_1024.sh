...
bash -c '
    ...
    output_dir="../data/output_atoms_1024_steps_20000000/T_${T}_seed_${seed}"
    ...
    python raw_data_generation.py --temperature "${T}" \
    --output_dir "${output_dir}" --seed "${seed}" \
    --number_of_steps 20000000 \
    --box_L 8 \
    --number_of_log_steps 10000 \
    --number_of_dump_steps 10000 \
