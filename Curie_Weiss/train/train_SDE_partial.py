...
parser.add_argument('--Task_NAME', default='curie_weiss', type=str)
...
parser.add_argument('--T', default=1.10, type=float)
# training parameters
...
parser.add_argument('--mode', default='constant_diagonal', type=str)
...
class Trainer():
    ...
    def load_data(self):
        ...
        self.z0_val = torch.load(f'{val_data_path}/z0_val.pt', map_location=self.device) # [n_tra, length_per_tra, hidden_dim]
        self.z1_val = torch.load(f'{val_data_path}/z1_val.pt', map_location=self.device) # [n_tra, length_per_tra, hidden_dim]  
