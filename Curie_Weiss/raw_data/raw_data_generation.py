...
import yaml
from utils.utils import glauber_continuous_CW
...
if __name__ == "__main__":
    ...
    if args.data_mode == 'val':
        ...
        for i in tqdm(range(X0_val.shape[0])):
            ...
            tra_dt, glauber_time = glauber_continuous_CW(tra.clone(), 1.0 / args.T, args.h)
        ...
        z0_val = torch.mean(X0_val.to(torch.float32), dim=(2, 3)) 
        z1_val = torch.mean(X1_val.to(torch.float32), dim=(2, 3)) 
