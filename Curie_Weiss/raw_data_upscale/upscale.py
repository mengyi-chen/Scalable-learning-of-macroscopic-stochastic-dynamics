...
def args_parser():
    ...
    # parser.add_argument('--box_L', type=int, nargs='+', default=[8], help="Length of the box: box_L (can be a list)")
...
if __name__ == "__main__":
    ...
    z0_train, z1_train_partial, time_step_train, z0_train_naive, z1_train_naive, idx_train_partial = generator.generate(X0_train, args.L_small, n_events=args.n_events)
