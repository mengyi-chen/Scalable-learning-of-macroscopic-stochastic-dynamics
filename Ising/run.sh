...
python raw_data_generation.py --L 64 --steps 500 --num_run 20 --mag 0.75 --data_mode test
...
python closure_modeling.py --patch_L 32

# for patch_L in "${patch_L_list[@]}"; do
#     python closure_modeling.py --patch_L $patch_L
# done

# Learn the SDE model for macroscopic dynamics
echo "Learning the SDE model for macroscopic dynamics..."
python train_SDE_partial.py --patch_L 32 --method ours
